...
class ICollectionViewPortlet(IPortletDataProvider):
    """
...
@implementer(ICollectionViewPortlet)
...
class AddForm(base.AddForm):
    ...
    schema = ICollectionViewPortlet
    label = _(u"Add Event Collection Portlet")
...
class EditForm(base.EditForm):
    ...
    schema = ICollectionViewPortlet
    label = _(u"Edit Event Collection Portlet")
    description = _(u"This portlet displays a listing of items from a "
                    u"Collection of events.")
