...
# Copiado de plone.app.layout-4.0.3-py3.11.egg/plone/app/layout/navigation/navtree.py
#
...
#
# Nos permite controlar que solo se muestren en el portlet los elementos que no estan
# excluidos de la navegación
