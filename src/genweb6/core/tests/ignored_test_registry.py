...
class TestRegistry(unittest.TestCase):
    ...
    def test_load_from_path_should_not_load_from_file_path_if_no_files_in_path(
        ...
        with patch(
                'genweb6.core.indicators.registry.Registry._load_from_file_path',
    ...
    def test_load_from_file_path_should_not_add_from_dict_if_empty_file(self):
        ...
        with patch(
                'genweb6.core.indicators.registry.Registry._add_indicator_from_dict',
    ...
    def test_add_indicator_should_override_existent_indicators(self):
        ...
        with patch('genweb6.core.indicators.model.Indicator.instance_from_dict',
