...
class INewsImage(ILeadImage):
    """Extend ILeadImage to add not_show_image field for news
    """
...
alsoProvides(INewsImage, IFormFieldProvider)


@implementer(INewsImage)
class NewsImage(object):
    """Adapter for INewsImage behavior
    """
