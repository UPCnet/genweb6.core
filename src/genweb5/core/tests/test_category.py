...
from genweb5.core.indicators import Calculator
...
class TestCategory(unittest.TestCase):
    ...
    def test_instance_from_dict_should_not_raise_error_for_unicode_id(self):
        category_dict = dict(
            id=u'category-id',
            description='Category description',
            calculator=u'genweb5.core.tests.test_category.MockCalculator',
        )
        Category.instance_from_dict(category_dict, None)
    ...
    def test_instance_from_dict_valid_dict_should_contain_not_none_values(self):
        ...
        with patch(
                'genweb5.core.indicators.model.Calculator.instance_from_string',
