...
''')
    ...
    def test_list_indicators(self):
        ...
        # Connection error
        with patch('genweb5.core.indicators.client.requests.get',
        ...
        with patch('genweb5.core.indicators.client.requests.get',
                ...
                'genweb5.core.indicators.client.Client._parse_response_list_indicators',
                side_effect=([],)):
    ...
    def test_list_categories(self):
        ...
        with patch('genweb5.core.indicators.client.requests.get',
                   side_effect=(response_mock,)), patch(
                'genweb5.core.indicators.client.Client._parse_response_list_categories',
                side_effect=([],)):
