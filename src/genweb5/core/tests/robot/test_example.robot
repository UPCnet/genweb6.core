...
#
#  $ bin/test -s genweb5.core -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src genweb5.core.testing.GENWEB5_CORE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/genweb5/core/tests/robot/test_example.robot
#
